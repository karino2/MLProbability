...
機械学習屋としては、測度が大きさを測る関数で、$$\mathscr{F}$$ がその大きさを測る対象だ、という事をしっかり覚えておく事が大切。
...
つまり $$\{2, 4, 6\} \in \mathscr{F}$$なら、$$\{1, 3, 5\} \in \mathscr{F}$$でも無くてはいけない、という事だ。
...
右辺も大きさを測る対象である必要がある。つまり、$$\mathscr{F}$$の中に入っていないと困る、という事だ。
...
という意味となる。
このintersectがまた $$\mathscr{F}$$ に入る、というのは、
